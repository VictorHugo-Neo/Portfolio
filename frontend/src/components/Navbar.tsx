...
export const Navbar = ({ isDarkMode, setIsDarkMode }: NavbarProps) => {
  return (
    <nav className={`fixed top-0 w-full z-50 backdrop-blur-md border-b py-4 transition-colors duration-500 ${isDarkMode
      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          ...
          <button
            ...
            className={`p-2.5 rounded-xl border transition-all active:scale-90 ${isDarkMode
